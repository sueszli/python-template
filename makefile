...
conda-req-to-yaml:
	...
	conda_env = {'name': 'con', 'channels': ['rusty1s', 'pytorch', 'nvidia', 'anaconda', 'conda-forge', 'defaults'], 'channel_priority': 'flexible', 'dependencies': [f'{package}={version}' for package, version in requirements_dict.items()] + ['python=3.11']}; \
